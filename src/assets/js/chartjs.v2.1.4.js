            ...
            (t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend(
              {
                ...
                update: function(t) {
                  ...
                  if (f < 2 * Math.PI) {
                    ...
                    g +=
                      2 * Math.PI * (g >= Math.PI ? -1 : g < -Math.PI ? 1 : 0);
                    var p = g + f,
                  ...
                  (a.outerRadius = Math.max(h / 2, 0)),
                    ...
                    (i.outerRadius =
                      a.outerRadius - a.radiusLength * i.getRingIndex(i.index)),
              ...
              updateElement: function(t, i, a) {
                ...
                void 0 !== h.radius &&
                  ...
                  (t._model = {
                    ...
                    pointStyle:
                      l.pointStyle ||
                      e.getValueAtIndexOrDefault(h.pointStyle, i, g.pointStyle),
                    ...
                    ? a.hasOwnProperty(i)
                      ...
                      : ((a[i] = []),
                        n.each(e, function(e) {
                          ...
                          a[i].push(
                            n.configMerge(t.scaleService.getScaleDefaults(o), e)
                          );
                        }))
                    : a.hasOwnProperty(i) &&
                      "object" == typeof a[i] &&
        ...
        e.exports = function(t) {
          ...
          (t.defaults.global.legend = {
            ...
            onClick: function(t, e) {
              ...
              (o.hidden =
                null === o.hidden ? !a.data.datasets[i].hidden : null),
                a.update();
            },
            labels: {
              boxWidth: 40,
                ...
                if (
                  ...
                  (n.textAlign = "left"),
                    ...
                    e.each(
                      ...
                      function(t, e) {
                        var i =
                          a.boxWidth + l / 2 + n.measureText(t.text).width;
                ...
                if (
                  ...
                  if (l) {
                    ...
                    (this.paddingLeft =
                      ...
                      (this.paddingRight =
                        0 !== this.labelRotation ? S * (h / 2) + 3 : y / 2 + 3);
                  } else {
              ...
              draw: function(i) {
                ...
                if (a.display) {
                  ...
                  if (((h.fillStyle = m), this.isHorizontal())) {
                    o = !0;
                    var _ =
                        "bottom" === a.position ? this.top : this.bottom - k,
                        ...
                        function(t, r) {
                          ...
                          if ((!l || s) && void 0 !== t && null !== t) {
                            ...
                            u.display &&
                              ...
                              u.drawOnChartArea &&
                                (h.moveTo(d, i.top), h.lineTo(d, i.bottom)),
                              h.stroke()),
                              c.display &&
                                (h.save(),
                                h.translate(
                    ...
                    if (
                          ...
                          if (void 0 !== t && null !== t) {
                            ...
                            if (
                              (u.display &&
                                ...
                                u.drawOnChartArea &&
                                  (h.moveTo(i.left, r), h.lineTo(i.right, r)),
                                h.stroke()),
                              c.display)
                            ) {
                              var s,
                              ...
                              h.save(),
                                "left" === a.position
                                  ? c.mirror
                                    ? ((s = this.right + c.padding),
                                      (h.textAlign = "left"))
                                    : ((s = this.right - c.padding),
                                      (h.textAlign = "right"))
                                  : c.mirror
                                    ? ((s = this.left - c.padding),
                                      (h.textAlign = "right"))
                                    : ((s = this.left + c.padding),
                                      (h.textAlign = "left")),
                      ...
                      var R =
                        "left" === a.position ? -0.5 * Math.PI : 0.5 * Math.PI;
                      h.save(),
                        h.translate(r, s),
                        h.rotate(R),
                        (h.textAlign = "center"),
                          ...
                          if (o) {
                            ...
                            n.push({
                              xLabel: o._xScale
                                ...
                                : "",
                              yLabel: r
                                ? r.getLabelForIndex(o._index, o._datasetIndex)
                                : "",
                              index: a._index,
                              datasetIndex: e
                            });
                      ...
                      function(t, i) {
                        ...
                        0 === i
                          ? (this._loop
                            ...
                            t._view.skip
                              ? this._loop ||
                                n.moveTo(r._view.x, this._view.scaleZero)
                ...
                return (
                  o.isHorizontal()
                    ...
                    : ((a = o.height - (o.paddingTop + o.paddingBottom)),
                      (i =
                        Math.pow(10, (o.bottom - o.paddingBottom - t) * n / a) /
                        o.start)),
                  i
                );
              }
              ...
              n = t.Scale.extend({
                  ...
                  if (
                    ...
                    for (var g = 0, p = i.units[g]; g < i.units.length; ) {
                      if (
                        ((this.unitScale = 1),
                        e.isArray(p.steps) &&
                          Math.ceil(this.scaleSizeInUnits / f) < e.max(p.steps))
                      ) {
                        for (var m = 0; m < p.steps.length; ++m)
                          if (
                            p.steps[m] >= Math.ceil(this.scaleSizeInUnits / f)
                          ) {
                            this.unitScale = e.getValueOrDefault(
                              this.options.time.unitStepSize,
                              p.steps[m]
                ...
                getPixelForValue: function(t, e, i, a) {
                  ...
                  if (o) {
                    ...
                    var h =
                        this.height - (this.paddingTop + this.paddingBottom),
                      d = (h / Math.max(this.ticks.length - 1, 1),
                      h * r + this.paddingTop);
